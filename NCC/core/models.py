...
#     user1 = models.OneToOneField(User, related_name="user11", on_delete=models.CASCADE)
#     user2 = models.OneToOneField(User, related_name="user22", on_delete=models.CASCADE,blank=True,null=True)
...
# #     '''
# #     user = models.OneToOneField(modelsPl.User, verbose_name=("allowed user"), on_delete=models.CASCADE)



# # class Rating(models.Model):
# #     user = models.ForeignKey(modelsPl.User, on_delete=models.CASCADE)
# #     rating = models.IntegerField(default=5)
# #     feedBack = models.TextField()
